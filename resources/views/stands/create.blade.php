                ...
                <div class="border-b border-white/10 pb-12">
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-4">
                            <label for="seller_category" class="block text-sm/6 font-medium text-white">Seller Category</label>
                            <div class="mt-2">
                                <div
                                    ...
                                    <select id="seller_category" name="seller_category"
                                        ...
                                        <option class="text-black" value="sneakers">Sneakers</option>
                                        <option class="text-black" value="kleding">Kleding</option>
                                        <option class="text-black" value="accessoires">Accessoires</option>
                                        <option class="text-black" value="verzamelobjecten">Verzamelobjecten</option>
                                    </select>
                                </div>
                            </div>
                        </div>
