            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/verkoper" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Verkoper</a>
                    </div>
                </div>
            </div>
        </div>
    </div>
</nav><?php /**PATH C:\phpprojects\Sneakerness\sneakerness-app\stands-overzicht\resources\views/components/navbar.blade.php ENDPATH**/ ?>